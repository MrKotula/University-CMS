...
class UserControllerTest {
    ...
    @Test
    void registrationMethodTest() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldRedirectToLogoutWhenEditEmailMethodTest() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldRedirectToUserWhenUpdatedDataMethodTest() throws Exception {
        mockMvc.perform(post("/user/editData/33c99439-aaf0-4ebd-a07a-bd0c550db4e1")
                        .param("firstName", "John")
                        .param("lastName", "Die")
                        .param("email", "")
